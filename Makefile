...
SRC_FOLDER :=\
				...
				src/entity/monster \
				src/entity/pnj \
				src/entity/pnj/animation \
				src/entity/player/     \
				src/entity/player/ui     \
				src/entity/player/item/     \
				src/entity/player/inventory/     \
				src/entity/player/animation     \
				src/scenes/main/	\
				src/scenes/map_editor/	\
				src/scenes/map/			\
				src/scenes/snow/			\
				src/scenes/desert/			\
				src/scenes/cave/			\
				src/scenes/option/		\
				src/scenes/controls/    \
				src/scenes/controls/controls_function\
				src/scenes/travel/      \
				src/scenes/pause/      	\
				src/scenes/				\
				src/map/				\
				src/quest/              \
				src/quest/quest_function\
				src/water/				\
				src/bloc/				\
				src/text/               \
				src/save/				\
...
IGNORE_SRC := . src/thread/thread.c
...
LIB_EXT :=	-lcsfml-graphics -lcsfml-window -lcsfml-system -lcsfml-audio -lcsfml-network -lm
## --------------------------------------------->
